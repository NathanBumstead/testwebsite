/*
<h1 class="welcome">Hi I'm <span class="selectric"></span></h1>



var selectric = document.querySelector('.selectric'),
    words = ['Hello', 'Namaste', 'Hallo', 'Hola', 'Bonjour', 'Nihao', 'مرحبا','Ciao','Salaam', 'Hello'];
let letterIndex = 0,
    wordIndex = 0;
...
$.fn.wordTypeErase = function(options) {
  ...
  var settings = $.extend({
    ...
    letterSpeed: 110,          // delay between letters typed
    highlightSpeed: 60,        // 
...
$el.typed({
			strings: ["First sentence.","TEST"],
			typeSpeed: 110,
      eraseAtOnce: true,
      onStringTyped: function() { $el.css( 'background-color', '#EFC137') },
      preStringTyped: function() {$el.css('background-color', 'transparent')},
});
...
$(document).ready(function() {
    $(window).scroll( function(){
        $('.fadein').each( function(i){
            ...
            var bottom_of_window = $(window).scrollTop() + $(window).height() + 130;
